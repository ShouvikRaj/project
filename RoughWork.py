...
ax.set_title("Average Temperature Distribution (1958-01-16 to 2019-03-16)", fontsize=14)

# Save with high resolution
plt.savefig('temperature_distribution_1080p.png', dpi=120, bbox_inches='tight')
plt.show()